  ...
  return (
    <>
      <div className="flex justify-between gap-4 px-2 md:px-0 pt-6 ">
        {step > 1 && (
          <button
            className="i py-2 px-4  text-sm font-medium rounded-md  bg-gray-50 hover:bg-gray-200 "
            onClick={() => {
              if (step > 1) {
                setStep(step - 1);
              }
        ...
        {step === 1 && (
          <button className="i py-2 px-4  text-sm font-medium rounded-md  bg-gray-50 hover:bg-gray-200 ">
            Cancel
          </button>
        )}
        <button
  ...
  return (
    <>
      <div className="animate-out slide-out-from-left">
        ...
        <label
          htmlFor="doc"
          className="flex items-center mb-[7px] p-4 gap-3 rounded-md border border-gray-300 border-dashed bg-gray-50 cursor-pointer"
        >
