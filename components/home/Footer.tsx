...
export default function Footer() {
  return (
    <>
      <footer className=" dark:bg-gray-800 bg-neutral-50">
        <div className="mx-auto max-w-screen-xl px-4 pb-6 pt-16 sm:px-6 lg:px-8 lg:pt-24 relative">
              ...
              <ul className="mt-8 flex justify-center gap-6 sm:justify-start md:gap-8">
                <li>
                  <a
                    ...
                    rel="noreferrer"
                    target="_blank"
                    className="text-gray-800 transition hover:text-gray-900/75 dark:text-gray-100 dark:hover:text-gray-100/75"
                  >
